        ...
        <div class="purchase-left-area">
            ...
            <div class="purchase-address">
                ...
                <div class="purchase-address-card">
                    @if (!empty($newaddress))
                    <div>
                        <input type="hidden" name="zipcode" value="{{ $newaddress['zipcode'] }}">
                        <input type="hidden" name="address" value="{{ $newaddress['address'] }}">
                        <input type="hidden" name="building" value="{{ $newaddress['building'] }}">
